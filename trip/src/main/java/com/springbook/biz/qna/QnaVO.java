...
public class QnaVO {
	...
	public String toString() {
		return "QnaVO [qna_num=" + qna_num + ", qna_user_id=" + qna_user_id + ", qna_regdate=" + qna_regdate
				+ ", qna_content=" + qna_content + ", qna_user_email=" + qna_user_email + ", qna_admin_id="
				+ qna_admin_id + ", qna_answer=" + qna_answer + ", qna_answer_date=" + qna_answer_date + "]";
	}
